...
public class BrushParameters : MonoBehaviour
{
    ...
    void InitializeDrawingSystem()
    {
        if (drawingSystem == null)
        {
            ...
            if (drawingSystem == null)
            {
                Debug.LogError("TattooDrawingSystem not found! Please assign it manually or ensure it exists in the scene.");
            }
        }
    }
    ...
    public void ApplyBrushSize()
    {
        if (drawingSystem != null)
        {
            ...
            Debug.Log($"Brush size applied: {brushSize}");
        }
        else
        {
            Debug.LogWarning("Drawing system reference not set!");
        }
    }
    ...
    public void ApplyColor()
    {
        if (drawingSystem != null)
        {
            ...
            UpdateColorHexCode();
            UpdateColorPreview();
            Debug.Log($"Brush color applied: {colorHexCode}");
        }
        else
        {
            Debug.LogWarning("Drawing system reference not set!");
